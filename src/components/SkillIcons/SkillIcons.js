...
export default function SkillIcons({ skillIconsRef, handleIconMouseLeave, handleIconMouseEnter }) {
  useEffect(() => {
    // console.log(skillIconsRef.current, 'child use')
  }, [])

  // console.log(skillIconsRef.current, 'child usooontse')

  return (
    <div>
      <ul ref={skillIconsRef} className="skills">
