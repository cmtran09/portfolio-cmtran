...
export default function Home() {
  ...
  console.log(skillIcons, 'parenoost')
    ...
    <main ref={elem => main = elem} >
      ...
      <section className="section skills-section" ref={elem => skillSection = elem}>
        <div className="container skills-wrapper">
          <SkillIcons skillIconsRef={skillIcons} handleIconMouseLeave={handleIconMouseLeave} handleIconMouseEnter={handleIconMouseEnter} />
        </div>
      </section >
