      ...
      <div class="columns">
        ...
        <div class="column is-10 main-gutter">
          ...
          <section className="section" ref={elem => projects = elem}>
            <ProjectLink projectName="System Monitor" dateComplete="2020" projectLink="" projectRepo="https://bit.ly/2Yfrk1e" projectVideo='src/video/system-monitor.mp4' projectImage='../../images/tetris.png' />
            ...
            <ProjectLink projectName="Text Translate" dateComplete="2019" projectLink="https://project-z-text-translate.herokuapp.com/" projectRepo="https://github.com/cmtran09/project-z-text-translate" projectVideo='src/video/text-translate.mp4' projectImage='../../images/tetris.png' />
            <ProjectLink projectName="NBA Comparison" dateComplete="2019" projectLink="https://bit.ly/2MKaMJp" projectRepo="https://bit.ly/2AyMtfk" projectVideo='src/video/nba.mp4' projectImage='../../images/tetris.png' />
...
// deployed projectVideo='src/video/scribble.mp4' 
// dev projectVideo='../../video/scribble.mp4'